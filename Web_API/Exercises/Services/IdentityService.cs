...
namespace Exercises.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<User> userManager, JwtSettings jwtSettings,
            TokenValidationParameters tokenValidationParameters, ExercisesContext context,
        ...
        public async Task<AuthenticationResult> RegisterAsync(string email, string password)
        {
            ...
            if (existingUser != null)
            {
                ...
                {
                    Errors = new[] { AuthenticationResult.UserWithMailAlreadyExists }
                };
            }
        ...
        public async Task<AuthenticationResult> LoginAsync(string email, string password)
        {
            ...
            if (user == null)
            {
                return new AuthenticationResult
                {
                    Errors = new[] {AuthenticationResult.UserDoesNotExist}
                };
            }
            ...
            if (!userHasValidPassword)
            {
                return new AuthenticationResult
                {
                    Errors = new[] {AuthenticationResult.WrongPassword}
                };
            }
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreshToken)
        {
            ...
            {
                return new AuthenticationResult {Errors = new[] {AuthenticationResult.InvalidToken}};
            }
            ...
            {
                return new AuthenticationResult {Errors = new[] {AuthenticationResult.TokenNotExpiredYet}};
            }
